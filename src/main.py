...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_connect_strength_EE', type=float, default=0.05)
    parser.add_argument('--max_connect_strength_EI', type=float, default=0.4)
    parser.add_argument('--max_connect_strength_IE', type=float, default=-0.3)
    parser.add_argument('--max_connect_strength_II', type=float, default=-0.2)
    parser.add_argument('--spatial_const_EE', type=float, default=0.5)
    parser.add_argument('--spatial_const_EI', type=float, default=0.5)
    parser.add_argument('--spatial_const_IE', type=float, default=0.5)
    parser.add_argument('--spatial_const_II', type=float, default=0.5)
    ...
    parser.add_argument('--conductance_EE', type=float, default=0.004)
    parser.add_argument('--conductance_EI', type=float, default=0.07)
    parser.add_argument('--conductance_IE', type=float, default=-0.04)
    parser.add_argument('--conductance_II', type=float, default=-0.015)
    ...
    parser.add_argument('--c2c_min_current', type=float, default=0.5)
    parser.add_argument('--c2c_max_current', type=float, default=2.3)
